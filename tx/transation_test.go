...
func TestTransationRollBack(t *testing.T) {
	...
	tx1 := NewTransaction(file_manager, log_manager, buffer_manager)
	...
	tx2 := NewTransaction(file_manager, log_manager, buffer_manager)
	tx2.Pin(blk)
	...
	tx3 := NewTransaction(file_manager, log_manager, buffer_manager)
	tx3.Pin(blk)
	...
	tx4 := NewTransaction(file_manager, log_manager, buffer_manager)
	tx4.Pin(blk)
